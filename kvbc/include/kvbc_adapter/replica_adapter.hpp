...
class ReplicaBlockchain : public IBlocksDeleter,
 ...
 public:
  ...
  ////////////////////////////Tools support//////////////////////////
  std::optional<concord::util::digest::BlockDigest> getParentDigest(BlockId block_id) {
    return kvbc_ == nullptr ? v4_kvbc_->parentDigest(block_id) : kvbc_->parentDigest(block_id);
  }

  std::optional<concord::util::digest::BlockDigest> calculateBlockDigest(BlockId block_id) {
