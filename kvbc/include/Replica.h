...
class Replica : public IReplica,
 ...
 private:
  ...
  struct Recorders {
    ...
    DEFINE_SHARED_RECORDER(get_block_duration, 500, MAX_VALUE_MICROSECONDS, concord::diagnostics::Unit::MICROSECONDS);
    DEFINE_SHARED_RECORDER(put_block_duration, 500, MAX_VALUE_MICROSECONDS, concord::diagnostics::Unit::MICROSECONDS);
  };
