...
void setUpKeysConfiguration_4() {
  replicaConfig.publicKeysOfReplicas.insert(std::pair<uint16_t, const string>(replica_0, publicKey_0));
  replicaConfig.publicKeysOfReplicas.insert(std::pair<uint16_t, const string>(replica_1, publicKey_1));
  replicaConfig.publicKeysOfReplicas.insert(std::pair<uint16_t, const string>(replica_2, publicKey_2));
  replicaConfig.publicKeysOfReplicas.insert(std::pair<uint16_t, const string>(replica_3, publicKey_3));
...
TEST_F(test_rocksdb, sm_prune_on_startup) {
  const auto replica_count = 4;
  const auto num_blocks_to_keep = 30;
  const auto replica_idx = 1;
  replicaConfig.numBlocksToKeep_ = num_blocks_to_keep;
...
TEST_F(test_rocksdb, sm_prune_on_state_transfer_complete) {
  const auto replica_count = 4;
  const auto num_blocks_to_keep = 30;
  const auto replica_idx = 1;
  replicaConfig.numBlocksToKeep_ = num_blocks_to_keep;
