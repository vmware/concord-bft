...
int main() {
  ...
  auto recorder1 = std::make_shared<Recorder>("histogram1", 500, MAX_VALUE_MICROSECONDS, Unit::MICROSECONDS);
  auto recorder2 = std::make_shared<Recorder>("histogram2", 500, MAX_VALUE_MICROSECONDS, Unit::MICROSECONDS);
  auto recorder3 = std::make_shared<Recorder>("histogram3", 500, MAX_VALUE_MICROSECONDS, Unit::MICROSECONDS);
  auto recorder4 = std::make_shared<Recorder>("histogram4", 500, MAX_VALUE_MICROSECONDS, Unit::MICROSECONDS);
