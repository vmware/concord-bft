 ...
 protected:
  ...
  struct HistogramRecorders {
    ...
    DEFINE_SHARED_RECORDER(time_in_reportBufferUsage,
                           MAX_DURATION_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    DEFINE_SHARED_RECORDER(time_in_returnBuffer, MAX_DURATION_MICROSECONDS, concord::diagnostics::Unit::MICROSECONDS);
    DEFINE_SHARED_RECORDER(caller_allocated_buffer_size, MAX_BUFFER_SIZE, concord::diagnostics::Unit::BYTES);
    DEFINE_SHARED_RECORDER(caller_allocated_buffer_usage, MAX_BUFFER_SIZE, concord::diagnostics::Unit::BYTES);
