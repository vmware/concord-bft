 ...
 *
 * WARNING: This class always receives shares as numbers between 1 and
 * MAX_NUM_OF_SHARES (inclusive!)
 *
 * WARNING: VectorOfShares::add() is not thread-safe because it increments a
 * counter (also not sure if std::bitset is thread-safe either)
 */
