 ...
 * Thanks to "Fast Batch Verification for Modular Exponentiation and Digital
 * Signatures"
 */
template <class GT>
...
/**
 * Computes r = \prod_{i \in s} { a[i]^e[i] } faster than naive method by
 * recursing on a fast way to compute a1^e1 * a2^e2.
 *
