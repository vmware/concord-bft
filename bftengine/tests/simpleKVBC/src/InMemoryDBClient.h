 ...
 *  @brief Header file containing the InMemoryDBClient and InMemoryDBClientIterator class definitions.
 *
 *  Objects of InMemoryDBClientIterator contain an iterator for the in memory object
 *  store (implemented as a map) along with a pointer to the map.
 *
 *  Objects of InMemoryDBClient are implementations of an in memory database (implemented as a map).
 *  The map contains key value pairs of the type KeyValuePair. Keys and values are of type Slice.
 *
 */
