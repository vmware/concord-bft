...
class DBDataStore : public DataStore {
 public:
  ...
  void setPrunedBlocksDigests(std::vector<std::pair<BlockId, STDigest>>& prunedBlocksDigests) override;
 ...
 protected:
  ...
  void serializePrunedBlocksDigests(std::ostream& os, std::vector<std::pair<BlockId, STDigest>>& digests) const;
  void deserializePrunedBlocksDigests(std::istream& is, std::vector<std::pair<BlockId, STDigest>>& digests) const;
  /**
