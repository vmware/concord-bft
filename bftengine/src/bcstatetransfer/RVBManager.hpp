...
/**
 * Range Validation Blocks Manager (RVBM) is part of BCStateTran (State Transfer). It's responsible of managing RVB data
...
class RVBManager {
 ...
 protected:
  ...
  // Actual RVB data
  // RangeValidationTree is an incomplete type, define a deleter for the uqnieu ptr
  struct rvt_deleter {
