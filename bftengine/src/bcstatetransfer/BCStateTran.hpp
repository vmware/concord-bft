...
#include "util/SimpleMemoryPool.hpp"
...
#pragma pack(pop)
 ...
 protected:
  struct Recorders {
    ...
    //////////////////////////////////////////////////////////
    // common
    DEFINE_SHARED_RECORDER(on_timer, 500, MAX_VALUE_MICROSECONDS, concord::diagnostics::Unit::MICROSECONDS);
    ...
    DEFINE_SHARED_RECORDER(compute_block_digest_duration,
                           ...
                           MAX_VALUE_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    DEFINE_SHARED_RECORDER(compute_block_digest_size, 500, MAX_BLOCK_SIZE, concord::diagnostics::Unit::COUNT);
    DEFINE_SHARED_RECORDER(time_to_clear_io_contexts,
                           500,
                           MAX_VALUE_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    // destination
    DEFINE_SHARED_RECORDER(dst_handle_ItemData_msg,
                           500,
                           MAX_VALUE_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    ...
    DEFINE_SHARED_RECORDER(dst_num_pending_blocks_to_commit,
                           ...
                           concord::diagnostics::Unit::COUNT);
    DEFINE_SHARED_RECORDER(dst_digest_calc_duration,
                           500,
                           MAX_VALUE_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    ...
    DEFINE_SHARED_RECORDER(src_handle_FetchResPages_msg_duration,
                           ...
                           MAX_VALUE_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    DEFINE_SHARED_RECORDER(src_get_block_size_bytes, 500, MAX_BLOCK_SIZE, concord::diagnostics::Unit::BYTES);
    DEFINE_SHARED_RECORDER(src_send_batch_duration,
                           500,
                           MAX_VALUE_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    ...
    DEFINE_SHARED_RECORDER(src_send_on_spot_batch_duration,
                           ...
                           MAX_VALUE_MICROSECONDS,
                           concord::diagnostics::Unit::MICROSECONDS);
    DEFINE_SHARED_RECORDER(src_send_batch_size_bytes, 500, MAX_BATCH_SIZE_BYTES, concord::diagnostics::Unit::BYTES);
    DEFINE_SHARED_RECORDER(src_send_batch_num_of_chunks, 500, MAX_BATCH_SIZE_BLOCKS, concord::diagnostics::Unit::COUNT);
  ...
  AsyncTimeRecorder src_send_batch_duration_rec_;
  AsyncTimeRecorder src_send_prefetched_batch_duration_rec_;
  AsyncTimeRecorder src_send_on_spot_batch_duration_rec_;
  AsyncTimeRecorder dst_time_between_sendFetchBlocksMsg_rec_;
  AsyncTimeRecorder time_in_incoming_events_queue_rec_;
  AsyncTimeRecorder time_in_post_processing_events_queue_rec_;
  AsyncTimeRecorder src_next_block_wait_duration_rec_;
