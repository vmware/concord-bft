...
IncomingMsgsStorageImp::IncomingMsgsStorageImp() : IncomingMsgsStorage() {
...
IncomingMsg IncomingMsgsStorageImp::popMsgForProcessing(std::chrono::milliseconds timeout) {
