...
inline TimeDeltaMirco subtract(
    Time t1, Time t2)  // TODO(GG): replace with absDifference (not sure that
...
class Timer {
 public:
  ...
  void changePeriodMilli(
      uint16_t timePeriodMilli);  // will be used after the next start
