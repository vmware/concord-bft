...
class ViewChangeSafetyLogic {
 public:
  ...
  // - If at the end of this method outMaxRestrictedSeqNum==0, then
  // outSafetyRestrictionsArray is 'empty'
  // - Otherwise, its first (outMaxRestrictedSeqNum-outMinRestrictedSeqNum+1)
  // elements are valid : they represents the restrictions between
  // outMinRestrictedSeqNum and outMaxRestrictedSeqNum
