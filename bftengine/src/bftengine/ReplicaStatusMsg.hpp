...
#pragma pack(pop)
  static_assert(sizeof(ReplicaStatusMsgHeader) == (2 + 8 + 8 + 8 + 1),
                "ReplicaStatusMsgHeader is 27B");

  static MsgSize calcSizeOfReplicaStatusMsg(
      bool listOfPrePrepareMsgsInActiveWindow,
      bool listOfMissingViewChangeMsgForViewChange,
      bool listOfMissingPrePrepareMsgForViewChange);

  ReplicaStatusMsgHeader* b() const {
    return (ReplicaStatusMsgHeader*)msgBody_;
  }
};
}  // namespace impl
}  // namespace bftEngine
