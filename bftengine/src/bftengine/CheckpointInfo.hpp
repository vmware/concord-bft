...
class CheckpointInfo {
 protected:
  ...
  MsgsCertificate<CheckpointMsg, true, true, true, CheckpointMsgCmp>*
      checkpointCertificate = nullptr;

  bool sentToAllOrApproved;

  Time executed;  // if != MinTime, represents the execution time of the
                  // corresponding sequnce number
