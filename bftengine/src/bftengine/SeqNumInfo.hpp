...
class SeqNumInfo {
 public:
  ...
  void getAndReset(PrePrepareMsg*& outPrePrepare,
  ...
  bool addSelfCommitPartialMsgAndDigest(CommitPartialMsg* m,
                                        Digest& commitDigest);
  ...
  bool isCommitted__gg()
      const;  // TODO(GG): beware this name may mislead (not sure...). rename ??
