...
namespace bftEngine
{
	namespace impl
	{
		...
		PartialExecProofMsg::PartialExecProofMsg(ReplicaId senderId, ViewNum v, SeqNum s, Digest& digest, IThresholdSigner* thresholdSigner) :
			MessageBase(senderId, MsgCode::PartialExecProof,
		...
		bool PartialExecProofMsg::ToActualMsgType(const ReplicasInfo& repInfo, MessageBase* inMsg, PartialExecProofMsg*& outMsg) {
