 ...
 public:
  ...
  class Context {
   public:
    ...
    void writeDigest(char* outDigest);  // write digest to outDigest, and
                                        // invalidate the Context object
    ~Context();
...
class RSAKeysGenerator {
 public:
  static bool generateKeys(std::string& outPublicKey,
                           std::string& outPrivateKey);
