...
class ControllerWithSimpleHistory : public ControllerBase {
 public:
  ...
  class SeqNoInfo {
   public:
    SeqNoInfo()
        : switchToSlowPath(false), prePrepareTime(0), durationMicro(0) {}
   ...
   private:
    ...
    std::set<ReplicaId>
        replicas;  // replicas that have responded for this sequence number
 ...
 protected:
  ...
  SequenceWithActiveWindow<EvaluationPeriod, 1, SeqNum, SeqNoInfo, SeqNoInfo>
      recentActivity;
