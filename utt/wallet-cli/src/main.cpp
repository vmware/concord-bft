...
int main(int argc, char* argv[]) {
  ...
  // [TODO-UTT] Synchronization can be optimized to require fewer requests by batching tx requests and/or filtering by user-id for
  // burns and mints
  ...
  // public balance -- print the number of ERC20 tokens the user has (needs a gRPC method to retrieve this value from the wallet service)
  // private balance -- print the number of UTT tokens the user has currently (compute locally)
