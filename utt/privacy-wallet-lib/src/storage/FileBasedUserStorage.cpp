...
void FileBasedUserStorage::setAppData(const std::string& key, const std::string& value) {
  state_["app_data"][key] = value;
}
...
std::string FileBasedUserStorage::getAppData(const std::string& key) {
