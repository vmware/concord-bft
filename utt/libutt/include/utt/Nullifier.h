...
namespace libutt {
     ...
     *
     * This is done by:
     *     (1) deriving a privacy-preserving nullifier h^{1/(s+sn)} which is not linkable to the coin owner's pid and their IBE encryption PK
     *     (2) adding this nullifer to a 'spent list'
     */
    class Nullifier {
    public:
        class Params {
    ...
    public:
        bool operator==(const Nullifier& o) const {
            return
                n == o.n &&
                y == o.y &&
                vk == o.vk &&
