...
class KzgPedEqProof {
 ...
 public:
  size_t getSize() const { return _g1_size + _g1_size + _g1_size + _gt_size + _fr_size; }
  KzgPedEqProof() {}

  KzgPedEqProof(const KZG::Params& kpp,
 ...
 public:
  ...
  bool verify(
      const KZG::Params& kpp, const CommKey& ck_val, const G1& kzgComm, const Fr& point, const Comm& pedComm) const {
...
class RangeProof {
 public:
  class Params {
   ...
   public:
    bool operator==(const Params& o) const { return ck_val == o.ck_val && kpp == o.kpp && true; }
 ...
 public:
  size_t getSize() const {
    return _g1_size + _g1_size + kzgPed_pi.getSize() + _fr_size + _g1_size + _fr_size + _g1_size + _fr_size + _g1_size;
  }
 ...
 public:
  ...
  // returns X - root
  static std::vector<Fr> getMonomial(const Fr& root) { return {-root, Fr::one()}; }
};
