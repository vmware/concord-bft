...
class SplitProof {
 ...
 public:
  size_t getSize() const { return _fr_size + sizeof(size_t) + alpha.size() * _fr_size; }
  SplitProof() {}

  SplitProof(std::istream& in) : SplitProof() { in >> *this; }

  SplitProof(const Params& p,
