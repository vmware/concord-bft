    ...
    public:
        ...
        public:
            ...
            > hashToOneTimeKeys(const GT& T, size_t ptxtSize) {
                ...
                for(size_t i = 0; i < numHashes; i++)
                    hashToBytes(T,
                        "ibe-otk",
                        std::string("ptxt|") + std::to_string(i), 
                        otk1.getBuf() + i * hashSize,
                        hashSize);
        ...
        public:
            size_t getSize() const {
                return 
                    _g1_size + 
                    sizeof(size_t) + buf1.size() +
                    sizeof(size_t) + buf2.size()
                    ;
            }
        ...
        public:
            bool operator==(const MPK& o) const {
                return p == o.p &&
                    mpk == o.mpk;
            }
        ...
        public:
            bool operator==(const EncSK& o) const {
                return mpk == o.mpk &&
                    pid == o.pid &&
                    encsk == o.encsk;
            }
