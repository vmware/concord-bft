...
namespace libutt {
    ...
    public:
        ...
        bool operator==(const RandSigShareSK& o) const {
            return x_and_ys == o.x_and_ys;
        }
    ...
    public:
        bool operator==(const RandSig& o) const {
    ...
    public:
         ...
         */
        static RandSig aggregate(size_t n, const std::vector<RandSigShare>& sigShares, const std::vector<size_t>& signerIds, const CommKey& ck, const std::vector<Fr>& r);

    public:
        bool operator==(const RandSigShare& o) const {
            return s1 == o.s1 &&
                s2 == o.s2 &&
                true;
        }
