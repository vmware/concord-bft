...
namespace libutt {
        ...
        const AutoBuf<unsigned char>& sigma)
    {
        ...
        return hashToField(std::string("ibe|hash-to-r")
            + "|" + mpkStr 
            + "|" + id
            + "|" + ptxtHex
            + "|" + sigmaHex
