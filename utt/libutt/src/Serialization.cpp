...
void libutt::BankSK::write(std::ostream& out) const {
    out << this->x << endl;
}
...
libutt::BankSK::BankSK(std::istream& in): BankSK() {
    this->read(in);
}
...
libutt::BankShareSK::BankShareSK(std::istream& in): BankShareSK() {
    this->read(in);
}

// Serialization/Deserialization for BankPK
void libutt::BankPK::write(std::ostream& out) const {
    out << this->X << endl;
}
...
libutt::BankPK::BankPK(std::istream& in): BankPK() {
    this->read(in);
}

// Serialization/Deserialization for BankSharePK
// read and write will be used from the parent class
void libutt::BankSharePK::read(std::istream &in) {
    this->BankPK::read(in);
}

void libutt::BankSharePK::write(std::ostream &out) const {
    this->BankPK::write(out);
}
...
libutt::CoinSig::CoinSig(std::istream& in) {
    this->read(in);
}
...
libutt::CoinSigShare::CoinSigShare(std::istream& in) {
    this->read(in);
}
...
libutt::RangeProof::RangeProof(std::istream& in) {
    this->read(in);
}
...
libutt::SplitProof::SplitProof(std::istream& in) {
    this->read(in);
}
...
libutt::TxIn::TxIn(std::istream& in): TxIn() {
    this->read(in);
}
...
libutt::TxOut::TxOut(std::istream& in): TxOut()
{
    this->read(in);
}
