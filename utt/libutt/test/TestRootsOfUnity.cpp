...
void print_all_accumulators(std::vector<Fr> roots,
                            const std::vector<Fr>& allRoots,
                            const std::vector<Fr>& p,
                            std::string nodeName);
...
void print_all_accumulators(std::vector<Fr> roots,
  ...
  std::cout << std::endl
            << std::left << std::setw(static_cast<int>(Utils::log2ceil(allRoots.size())))
