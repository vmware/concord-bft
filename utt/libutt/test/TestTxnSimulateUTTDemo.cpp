...
void pickCoinsVaraint1(const Simulation::Context& ctx, Wallet& w1, Wallet& w2, size_t payment, std::set<std::string>& nullset, std::vector<Wallet>& wallets) {
...
void pickCoinsVaraint2(const Simulation::Context& ctx, Wallet& w1, Wallet& w2, size_t payment, std::set<std::string>& nullset, std::vector<Wallet>& wallets) {
    // Precondition: 0 < payment <= budget <= balance
