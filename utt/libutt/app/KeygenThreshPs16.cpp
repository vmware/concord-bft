...
int main(int argc, char *argv[]) {
  ...
  if (argc < 5) {
    ...
    cout << endl;
    cout << "Picks a random Pointcheval-Sanders'16 (PS16) secret key and (t, n) secret shares it amongst n servers so "
            "that any subset of t servers can reconstruct it."
         << endl;
  ...
  size_t t = static_cast<size_t>(std::stoi(argv[3])), n = static_cast<size_t>(std::stoi(argv[4]));
