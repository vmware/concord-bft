...
class IStorage {
 public:
  ...
  /**
   * @brief Set the Last Executed sequence number known by the user
   *
   * @param seq_num the last executed sequence number known by the user
   */
  virtual void setLastExecutedSn(uint64_t seq_num) = 0;
  ...
  /**
   * @brief Get the Last Executed Sequence number stored by setLastExecutedSn
   *
   * @return uint64_t
   */
