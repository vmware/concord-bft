...
struct Recorders {
  ...
  DEFINE_SHARED_RECORDER(processing_duration, MAX_VALUE_MICROSECONDS, concord::diagnostics::Unit::MICROSECONDS);
  DEFINE_SHARED_RECORDER(write_duration, MAX_VALUE_MICROSECONDS, concord::diagnostics::Unit::MICROSECONDS);
};
