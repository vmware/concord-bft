...
class Client {
 ...
 private:
  ...
  struct Recorders {
    ...
    DEFINE_SHARED_RECORDER(sign_duration, MAX_VALUE_NANOSECONDS, concord::diagnostics::Unit::NANOSECONDS);
    DEFINE_SHARED_RECORDER(transaction_size, MAX_TRANSACTION_SIZE, concord::diagnostics::Unit::BYTES);
