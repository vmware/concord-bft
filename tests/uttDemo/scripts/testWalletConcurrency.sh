...
# Validate
awk -v x=${EXPECTED_BLOCK_ID} '$2 != x {print "Error: unexpected block id!",$0}' automation/summary_*
awk -v x=${EXPECTED_PUBLIC_BALANCE} '$3 != x {print "Error: unexpected public balance!",$0}' automation/summary_*